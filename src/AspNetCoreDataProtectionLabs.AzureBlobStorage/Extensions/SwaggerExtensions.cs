...
namespace AspNetCoreDataProtectionLabs.AzureBlobStorage.Extensions
{
    /// <summary>
    /// Swagger extensions.
    /// </summary>
    public static class SwaggerExtensions
    {
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = "v1",
                    Title = "AspNetCore DataProtection: Azure Blob Storage",
                    Description = "AspNetCore DataProtection Labs Azure Blob Storage",
        ...
        public static IApplicationBuilder UseCustomSwagger(this IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "AspNetCore DataProtection: Azure Blob Storage API (V1)");
                options.DocumentTitle = "AspNetCore DataProtection: Azure Blob Storage";
